            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{__('home.roles')}}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a type="button" class=" btn bg-green" href="{{route('roles-create')}}" style="float: right;"> {{__('home.add')}} {{__('home.roles')}} </a>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach($items as $item)
                                        <tr>
                                            ...
                                            <td><a href="{{route('roles-edit',$item->id)}}" class="btn btn-info"><i class="fa fa-edit"></i> </a></td>
                                        </tr>
                                        @endforeach
