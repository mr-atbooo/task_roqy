...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{__('home.add')}} {{__('home.users')}}</h1>
                </div>
                <div class="col-sm-6">
...
{{--                        </div>--}}
                        <!-- /.card-header -->
                        <!-- form start -->
                            {!! Form::open(['route'=>'users-store' ,'enctype'=>'multipart/form-data','role'=>'form'])!!}

                            <div class="card-body">
                                <div class="form-group col-6" style="float: left;">
                                    <label for="name">Name</label>
                                    <input type="text" name="name"  value="{{old('name')}}" required class="form-control  {{ $errors->has('name') ? 'is-invalid' : '' }}" id="name" placeholder="Enter name">
                                    @error('title')
                                ...
                                <div class="form-group col-6" style="float: left;">
                                    ...
                                    <input type="email" name="email"  value="{{old('email')}}" required class="form-control  {{ $errors->has('email') ? 'is-invalid' : '' }}" id="email" placeholder="Enter email">
                                    @error('email')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
