...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{__('home.add')}} {{__('home.magazines')}}</h1>
                </div>
                <div class="col-sm-6">
...
{{--                        </div>--}}
                        <!-- /.card-header -->
                        <!-- form start -->
                            {!! Form::open(['route'=>'magazines-store' ,'enctype'=>'multipart/form-data','role'=>'form'])!!}
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" name="img" required accept="image/*" class="custom-file-input" id="img">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="ckeditor form-control"   required="required"  name="desc" placeholder="Description">{{old('desc')}}</textarea>
                                    @error('desc')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="views"  class="form-control {{ $errors->has('views') ? 'is-invalid' : '' }}" value="{{old('views')}}" id="views" placeholder="views">
                                    @error('views')
                                     <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" checked name="Publish" id="Publish">
