                        ...
                        <div class="contact-form">
                            <form action="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" id="inputPassword" class="form-control" placeholder=" Write Your password">
                                </div>
                               

                                <div class="text-center p-2">
                                    <button type="submit" class="btn btn-gradiant">
                                       <a href="movies-demos.html">login</a> 
                                    </button>
                                </div>

                                <div >
                                   <b> <span>Don't Have An Account ?</span> <a href="sign-up.html" class="main-color ">Sign Up</a></b>
                                </div>
                            </form>
                        </div>
                    </div>
